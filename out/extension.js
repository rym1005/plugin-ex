...
class XcodeSidebarProvider {
    ...
    async insertXcodeCode(loplatId, loplatPw) {
    ...
    insertLineIntoSwiftFile(filePath, lineToInsert, targetKeyword, loplatId, loplatPw) {
        ...
        if (targetKeyword === 'func application') {
            const insertionIndex = lines.findIndex(line => line.includes('func application') && line.includes('didFinishLaunchingWithOptions'));
            if (insertionIndex !== -1) {
